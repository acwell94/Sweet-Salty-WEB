...
export const IntroPresenter = () => {
  return (
    <S.Wrapper>
      ...
      <S.Title50px>
        <S.HiSpan>어서오세요, </S.HiSpan>
        <S.Span>단짠 맛집</S.Span> 입니다!
      </S.Title50px>
      ...
      <S.Contents20px>
        ...
        <S.ContentsWrite>
          가보고 싶은 맛집을 찾으면서 불필요한 정보가 싫었던 여러분께
        </S.ContentsWrite>
        <S.ContentsWrite>
          글에서만 느낄 수 있었던 솔직한 감칠맛을 제공해드립니다.
        </S.ContentsWrite>
      </S.Contents20px>

      <S.ContentsMiddle20px>
        <S.ContentsWrite>
          전국에 계시는 단짝님들의 단맛, 짠맛의 게시글을 통해 맛집 정보를
          확인하고
        </S.ContentsWrite>
        <S.ContentsWrite>
          소통하고 싶은 단짝을 팔로우하며, 맛집 식사권도 구매하고 직접
          경험해보세요.
        </S.ContentsWrite>
      </S.ContentsMiddle20px>

      <S.Contents20px>
        <S.ContentsWriteNoMedia>
          여러 이유로 맛집에 갈 수 없었던 맛객님과 코로나로 인해 힘드신
          소상공인분들을 위해
        </S.ContentsWriteNoMedia>
        <S.ContentsWriteMedia>
          <S.ContentsWriteMedia>
            여러 이유로 맛집에 갈 수 없었던 맛객님과
          </S.ContentsWriteMedia>
          코로나로 인해 힘드신 소상공인분들을 위해
        </S.ContentsWriteMedia>
        <S.ContentsWrite>
          저희 단짠 맛집 서비스는 다양한 맛을 제공해드리며 응원합니다.
        </S.ContentsWrite>
      </S.Contents20px>

      <S.TeamTitle>프로젝트 팀원 소개</S.TeamTitle>
      <S.DeveloperBox>
